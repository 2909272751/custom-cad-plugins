...
| `beamcolor` | `BEAMCOLOR` | 按梁编号前缀批量修改梁编号文字和目标图层线条颜色，跳过配筋文字。 | [下载 DLL](https://github.com/2909272751/custom-cad-plugins/releases/download/v0.1.5/beamcolor-v0.1.5-autocad2021.dll) |
