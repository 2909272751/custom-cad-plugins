...
| `beamnumsel` | `BEAMNUMSEL` | 按梁线图层和文字图层预选梁上数字，可选横竖方向、所在侧和最大识别距离。 | [下载 DLL](https://github.com/2909272751/custom-cad-plugins/releases/download/v0.1.1/beamnumsel-v0.2.0-autocad2021.dll) |
