...
| `beamcolor` | `BEAMCOLOR` | 按梁编号前缀批量修改梁编号文字和对应梁线颜色，跳过配筋文字。 | [下载 DLL](https://github.com/2909272751/custom-cad-plugins/releases/download/v0.1.1/beamcolor-v0.1.0-autocad2021.dll) |
