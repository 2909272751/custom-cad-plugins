...
这个仓库是一个 AutoCAD 插件合集，目前包含 6 个彼此独立的插件。
...
| 插件 | 命令 | 一句话功能 | 下载 |
| --- | --- | --- | --- |
| 简易说明 | - | 简短说明六个插件分别做什么，以及通用 NETLOAD 加载方法。 | [下载 TXT（自建CAD插件-v0.1.1-简易说明）](https://github.com/2909272751/custom-cad-plugins/releases/download/v0.1.1/custom-cad-plugins-v0.1.1-quick-guide.txt) |
